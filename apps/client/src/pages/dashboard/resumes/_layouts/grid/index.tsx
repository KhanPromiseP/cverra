...
// client/components/dashboard/grid-view.tsx
import { t, Trans } from "@lingui/macro";
import { sortByDate } from "@reactive-resume/utils";
import { motion } from "framer-motion";
    ...
    <div className="space-y-6 pb-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-gray-600 text-sm md:text-base dark:text-gray-400 mt-2">
            {t`Craft standout resumes that get noticed by recruiters in no time. Choose your starting point-create from scratch, import, or let AI build from your existing resume.`}
          </p>
        </div>
        
        {/* Action cards container - Now 3 cards */}
            ...
            {resumes.length === 0 ? (
              ...
              <div className="text-center py-12 px-4">
                <div className="mx-auto max-w-md">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    {t`Start building your career journey with Inlirah. Create, import, or let AI build your first professional resume.`}
                  </p>
                </div>
              </div>
            ) : (
