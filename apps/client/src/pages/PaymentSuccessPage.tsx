      ...
      <div className="max-w-md mx-auto">
              ...
              {paymentStatus.amount && paymentStatus.coins && (
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Coins Received:</span>
                    <span className="font-semibold text-green-600 dark:text-green-400">
                      {paymentStatus.coins.toLocaleString()} coins
                    </span>
                  </div>
            ...
            <>
              ...
              <div className="animate-pulse bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-6">
                <p className="text-yellow-800 dark:text-yellow-200 text-sm">
                  ⚠️ Your payment is being processed. This may take a few minutes.
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Need help? <a href="/support" className="text-blue-600 dark:text-blue-400 hover:underline">Contact Support</a>
          </p>
        </div>
      </div>
    </div>
